        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="sup_main">
                        <h4 class="text-center">Supervisor Settings</h4>
                        <div class="settings_wrap">
                            <div class="profile">
                                <h4 class="text-center">Supervisor Profile</h4>
                            ...
                            <div class="pswd_change form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="password" name="newPswd" ref="newPswd" class="form-control" v-model="newPswd" v-validate="'required|min:5|max:20'" data-vv-as="new password">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="password" class="form-control" name="confPswd" v-model="confPswd" v-validate="'required|confirmed:newPswd'" data-vv-as="confirm password">
...
export default {
    ...
    methods: {
        getSupDetails(){
            axios.get('/sup_getprofile').then((res) => {
