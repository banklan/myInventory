<template>
   <div class="admin_wrap">
       <div class="sidebar">
        ...
        <div class="main">
            <div class="breadcrumb"><router-link :to="{name: 'admin'}">Dashboard</router-link> > Settings</div>
            <div class="user_wrap">
                ...
                <div class="settings_wrap">
                    ...
                    <div class="pswd_change form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="password" name="newPswd" ref="newPswd" class="form-control" v-model="newPswd" v-validate.disable="'required|min:5|max:20'" data-vv-as="new password">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="password" class="form-control" name="confPswd" v-model="confPswd" v-validate.disable="'required|confirmed:newPswd'" data-vv-as="confirm password">
